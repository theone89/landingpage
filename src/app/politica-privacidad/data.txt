...
export function Policy() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <ul className="list-disc pl-8 mb-8">
        ...
        <li className="mb-2">
          <p>
            ...
            this Agreement) refers to StrongFreeCode.
          </p>
        </li>
        <li className="mb-2">
          <p>
        ...
        <li className="mb-2">
          <p>
            <strong>Country</strong> refers to: Cuba
          </p>
        </li>
        <li className="mb-2">
          <p>
        ...
        <li className="mb-2">
          <p>
            <strong>Website</strong> refers to strongfreecode, accessible from{" "}
            <a
      ...
      <h3 className="text-xl font-medium mb-2">Delete Your Personal Data</h3>
      <p className="mb-4">
      ...
      <ul className="list-disc pl-8 mb-8">
        <li className="mb-2">
          <p>By email: contact@strongfreecode.com</p>
        </li>
        <li className="mb-2">
          <p>
        ...
        <li className="mb-2">
          <p>By phone number: +52296110304</p>
        </li>
        <li className="mb-2">
          <p>By mail: ,La Habana, Cuba, 10700</p>
        </li>
      </ul>
    </div>
  );
